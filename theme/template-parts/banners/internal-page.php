...
?>
<div class="xl:h-[900px] lg:h-[800px] md:h-[600px] sm:h-[500px] h-[400px] overflow-hidden w-full bg-no-repeat lg:bg-cover bg-contain" style="background: url('<?= esc_url(wp_get_attachment_url($featured_image_id)); ?>');">
