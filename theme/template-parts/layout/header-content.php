...
<header class="absolute w-full py-6 z-50" id="masthead">
	...
	<div id="primary-menu" class="hidden fixed top-0 right-0 bg-white p-8 shadow-md h-screen xl:w-1/6 lg:w-1/4 md:w-1/5 w-2/3">
		<div class="flex flex-col justify-between h-full">
			...
			<div class="mt-auto flex justify-between items-center">
				<a href="https://www.facebook.com/umbsolut.ec" target="_blank">
				...
				<a href="https://wa.me/593999162467?text=Escríbenos%20y%20cotiza%20con%20nosotros%20ahora." target="_blank">
